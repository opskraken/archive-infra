...
description: Suggest a new feature for the archive-infra MVP
title: '[Feature] archive-infra - Brief title'
  ...
  - type: markdown
    attributes:
      value: |
        ...
        ### 1. Problem/Need
        What user pain point does this solve? [e.g., "Lost configs hinder recovery"]
        
        ### 2. Proposed Solution
        High-level: What should the feature do? [e.g., "Centralized archive with Terraform"]
        ...
        - Impact: [e.g., "High: Core to archive infrastructure configs for traceability."]
